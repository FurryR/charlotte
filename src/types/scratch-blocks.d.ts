// Modified version of @turbowarp/types/types/scratch-blocks.d.ts
...
declare namespace ScratchBlocks {
  ...
  class BlocklyProcedures {
      addCreateButton_ (workspace: Workspace, xmlList: HTMLElement[]): void;
  }

  interface RealBlockly {
    Workspace: WorkspaceConstructor;
    WorkspaceSvg: typeof WorkspaceSvg;
    Procedures: BlocklyProcedures;
